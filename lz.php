...
<html lang="zh-CN">
  ...
  <div class="mdui-text-center mdui-color-theme-a200 mdui-text-color-white" style="padding-top: 80px; padding-bottom: 80px; background-color:#448aff!important;">
   <div class="mdui-typo-display-1">蓝奏云链接解析</div>
   <br>
   <div class="mdui-typo-subtitle">快速获取蓝奏云下载直链</div>
  </div>
  </div>
  ...
  <div class="mdui-row-center wrapper">
   <div class="mdui-col-sm-6" style="width: 100%;">
    <div class="mdui-m-t-2">
     <p><b>请求地址：</b>
     <br/>
     <a id="text" href="http://apimoe.lol/api/lz/?url=xx&pass=xxxx">https://apimoe.lol/api/lz/?url=xx&pass=xxxx</a>
    ...
    <b>请求示例：</b>
    <br/>
    <a id="text1" href="https://apimoe.lol/api/lz/?url=https://wwd.lanzouj.com/iu3mDj6q3mb&pass=3irz">https://apimoe.lol/api/lz/?url=<br>https://wwd.lanzouj.com/iu3mDj6q3mb<br>&pass=3irz</a>
    <textarea id="input">隐藏按钮</textarea>
    <button onclick="copyText()" class="mdui-btn mdui-btn-icon mdui-ripple url">
    <i class="mdui-icon material-icons">content_copy</i>
    </button>
