...
<html lang="zh-CN">
  ...
  <body class="mdui-drawer-body-left mdui-drawer-full-height" style="padding-top: 100px;">
    ...
    <div class="mdui-drawer mdui-shadow-1 mc-drawer" id="drawer">
      ...
      <a href="/zh-cn/lz_url" class="mdui-list-item mdui-ripple mdui-list-item-active">
  ...
  <div class="mdui-text-center mdui-color-theme-a200 mdui-text-color-white" style="padding-top: 80px; padding-bottom: 80px; background-color:#448aff!important;">
   <div class="mdui-typo-display-1">蓝奏云直接下载</div>
   <br>
   <div class="mdui-typo-subtitle">直接下载蓝奏云文件</div>
  </div>
  </div>
  ...
  <div class="mdui-row-center wrapper1">
   <div class="mdui-col-sm-6" style="width: 100%;">
    <div class="mdui-m-t-2">
     <p><b>请求地址：</b>
     <br/>
     <a id="text" href="http://apimoe.lol/api/lz_url/?url=xx&pwd=xxxx">https://apimoe.lol/api/lz_url/?url=xx&pwd=xxxx</a>
    ...
    <b>请求示例：</b>
    <br/>
    <a id="text1" href="https://apimoe.lol/api/lz_url/?url=https://wwd.lanzoue.com/ibez8kd&pwd=f5vi">https://apimoe.lol/api/lz_url/?url=<br>https://wwd.lanzouj.com/iu3mDj6q3mb<br>&pwd=3irz</a>
    <textarea id="input">隐藏按钮</textarea>
    <button onclick="copyText()" class="mdui-btn mdui-btn-icon mdui-ripple url">
    <i class="mdui-icon material-icons">content_copy</i>
    </button>
