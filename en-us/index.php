...
<html lang="“zh-CN”">
  ...
  <body class="mdui-drawer-body-left mdui-drawer-full-height" style="padding-top: 100px;">
    ...
    <div class="mdui-drawer mdui-shadow-1 mc-drawer" id="drawer">
      ...
      <a href="/zh-cn/lz/" class="mdui-list-item mdui-ripple">
        ...
        <div class="mdui-list-item-content">LanZou Cloud url</div>
      </a>
      <a href="/zh-cn/imageapi" class="mdui-list-item mdui-ripple">
        ...
        <div class="mdui-list-item-content">Random Image API</div>
      </a>
      <li class="mdui-subheader">联系方式/Contact Details</li>
      <a href="https://jq.qq.com/?_wv=1027&k=hFdySg2N" class="mdui-list-item mdui-ripple">
        ...
        <div href="https://jq.qq.com/?_wv=1027&k=hFdySg2N" class="mdui-list-item-content">QQ Group</div>
      </a>
      ...
      <a href="https://www.miaofile.com" class="mdui-list-item mdui-ripple">
        ...
        <div class="mdui-list-item-content">Miao File</div>
      </a>
     </div>
     <div class="copyright">
      <p>
  ...
  <div id="page-index" class="mdui-container">
    <div class="banner">
      ...
      <div class="meta">
      A collection of all API links and usage methods under TCB Work.
      </div>
      <div class="actions">
      ...
      <div class="more-meta mdui-typo">
        <span class="current">Later Version：v1.0.0</span
        ><span
          ><a
            ...
            <div class="row">
                <div class="utf-site-heading text-center">
                    <div class="col-md-8 col-md-offset-2">
                        <h2><span>Special </span>Thanks to</h2>
                        <p>Special thanks to the server and website template provided by 熊可狸</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="utf-team-items utf-team-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <div class="info mdui-ripple">
                                ...
                                <span>Website source code provider, Minecraft Java version server underlying architecture developer</span>
                                <p>Hmm... that's it, it's a very homely dead house! I usually like to toss! There is so much more to learn</p>
                            </div>
                        </div>
                        <!--Start KumaAli-->
                    </div>
